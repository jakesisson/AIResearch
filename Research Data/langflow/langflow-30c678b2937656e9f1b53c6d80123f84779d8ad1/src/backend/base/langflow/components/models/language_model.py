...
class LanguageModelComponent(LCModelComponent):
    ...
    inputs = [
        ...
        StrInput(
            ...
            info="Azure OpenAI endpoint URL (required for Azure OpenAI provider)",
            advanced=True,
            show=False,
        ),
        StrInput(
        ...
        StrInput(
            ...
            info="Azure OpenAI deployment name",
            advanced=True,
            show=False,
        ),
        MessageInput(
    ...
    def build_model(self) -> LanguageModel:
        ...
        if provider == "Azure OpenAI":
            ...
            if not self.azure_endpoint:
                msg = "Azure OpenAI endpoint is required when using Azure OpenAI provider"
                raise ValueError(msg)
            azure_deployment = self.azure_deployment or model_name
            azure_api_version = self.azure_api_version or "2025-01-01-preview"
            return ChatOpenAI(
    ...
    def update_build_config(self, build_config: dotdict, field_value: Any, field_name: str | None = None) -> dotdict:
        if field_name == "provider":
            if field_value == "OpenAI":
                ...
                build_config["azure_api_version"]["show"] = False
                ...
                build_config["azure_api_version"]["show"] = True
