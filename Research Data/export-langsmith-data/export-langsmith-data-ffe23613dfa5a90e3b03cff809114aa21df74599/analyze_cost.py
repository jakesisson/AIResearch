...
EXAMPLE_PRICING_CONFIGS = {
    "azure_openai_gpt4": PricingConfig(
        model_name="Azure OpenAI GPT-4",
        input_tokens_per_1k=0.03,  # $30 per 1M input tokens
        output_tokens_per_1k=0.06,  # $60 per 1M output tokens
        cache_read_per_1k=0.03,  # Same as input for cache reads
    ),
    "azure_openai_gpt35_turbo": PricingConfig(
        model_name="Azure OpenAI GPT-3.5 Turbo",
        input_tokens_per_1k=0.0005,  # $0.50 per 1M input tokens
        output_tokens_per_1k=0.0015,  # $1.50 per 1M output tokens
        cache_read_per_1k=0.0005,  # Same as input for cache reads
    ),
