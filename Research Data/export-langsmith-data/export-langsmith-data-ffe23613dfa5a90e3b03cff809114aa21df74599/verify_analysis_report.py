...
def main() -> int:
    ...
    parser.add_argument(
        "--pricing-model",
        type=str,
        default="azure_openai_gpt35_turbo",
        help="Pricing model for cost analysis (default: azure_openai_gpt35_turbo). Options: azure_openai_gpt4, azure_openai_gpt35_turbo, gemini_1.5_pro",
    )
    ...
    if run_3b:
        if args.pricing_model in EXAMPLE_PRICING_CONFIGS:
            ...
            print(
                f"\nWarning: Unknown pricing model '{args.pricing_model}', using azure_openai_gpt35_turbo"
            )
            pricing_config = EXAMPLE_PRICING_CONFIGS["azure_openai_gpt35_turbo"]
