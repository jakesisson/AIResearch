...
class OpenAIProvider(BaseLLMProvider):
    ...
    def get_info(self) -> Dict[str, Any]:
        ...
        info = {
            ...
            "azure_openai": bool(self.azure_endpoint and self.azure_api_key),
            "azure_endpoint": self.azure_endpoint if self.azure_endpoint else None,
            "azure_deployment": self.azure_deployment if self.azure_deployment else None,
            "azure_api_version": self.azure_api_version if self.azure_endpoint else None,
        }
        return info