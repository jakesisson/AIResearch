#!/usr/bin/env python3
"""
Cost & performance test for ai-resume-agent (researched commit).
Single Azure OpenAI call to measure tokens and latency. No DB or RAG chain.
Loads master.env from AIResearch if present. Set COST_PERF_VARIANT=researched|prior for compare.
"""
import os
import sys
import json
