#!/usr/bin/env python3
"""
Runs cost-perf test on both prior and researched ai-resume-agent clones, then writes a comparison report.
Loads master.env from AIResearch so Azure vars are available.

Usage (from Research Data/ai-resume-agent):
...
PRIOR_DIR = ROOT / "ai-resume-agent-d251ed01d4dbdc6ea94ff8cdf43005ab995ea5f6"
RESEARCHED_DIR = ROOT / "ai-resume-agent-0ad71e1993b2e1361290dc93d5d04a11b66c8bdf"
