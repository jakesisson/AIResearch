...
from .rarity_generate import generate as rarity_generate
from .sandbox import configure as sandbox_config
from .risk import load_persistent_weights, save_persistent_weights, describe
...
def sandbox(dry_run: bool = typer.Option(None), timeout: float = typer.Option(None), max_output: int = typer.Option(None)):
    cfg = sandbox_config(dry_run=dry_run, timeout_sec=timeout, max_output_bytes=max_output)
