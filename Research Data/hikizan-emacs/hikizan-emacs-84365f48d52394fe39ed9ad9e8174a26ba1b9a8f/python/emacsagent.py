...
# Azure OpenAI configuration (takes precedence if set)
...
MODEL_NAME = os.getenv("MODEL_ID", "gpt-4.1")
LLM_TEMPERATURE = 0
TIMEOUT = 60
...
# Note: Gemini-specific conversation flow fixes removed as we're using Azure OpenAI/OpenAI
# OpenAI models handle conversation flow natively without special fixes
...
class EmacsAgent:
    ...
    def __init__(self):
        ...
        if AZURE_OPENAI_ENDPOINT and AZURE_OPENAI_API_KEY:
            ...
            raise ValueError(
                "Either AZURE_OPENAI_ENDPOINT and AZURE_OPENAI_API_KEY, "
                "or OPENAI_API_KEY environment variable must be set."
            )
...
if __name__ == "__main__":
    ...
    #    export AZURE_OPENAI_API_DEPLOYMENT='gpt-4.1'  # Optional, defaults to MODEL_ID or 'gpt-4.1'
    #    OR set standard OpenAI:
    #    export OPENAI_API_KEY='your_key_here'
    #    export MODEL_ID='gpt-4.1'  # Optional, defaults to 'gpt-4.1'
