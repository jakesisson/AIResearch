...
if config.AZURE_OPENAI_API_KEY and config.AZURE_OPENAI_ENDPOINT:
    # For Azure OpenAI, use base_url with deployment and api-version query param
    # Format: https://{instance}.openai.azure.com/openai/deployments/{deployment}/chat/completions?api-version={version}
