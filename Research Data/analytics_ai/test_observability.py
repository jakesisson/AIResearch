...
cost-perf output appears (e.g. "Cost-perf", "create_analysis_plan_node"). Writes .cost-perf-observability.json.
"""
import json
import os
import sys
...
MARKERS = [b"Cost-perf", b"create_analysis_plan_node", b"durationMs", b"variant"]
